...
@implementation UIView (PLVLayout)
...
+ (void)showOscillatoryAnimationWithLayer:(CALayer *)layer type:(PLVOscillatoryAnimationType)type{
    NSNumber *animationScale1 = type == PLVOscillatoryAnimationToBigger ? @(1.15) : @(0.5);
    NSNumber *animationScale2 = type == PLVOscillatoryAnimationToBigger ? @(0.92) : @(1.15);
