...
@implementation PLVImageCropManager
...
+ (UIImage *)cropImageView:(UIImageView *)imageView toRect:(CGRect)rect zoomScale:(double)zoomScale containerView:(UIView *)containerView {
    ...
    cropedImage = [[PLVImageManager manager] fixOrientation:cropedImage];
...
+ (UIImage *)sd_tz_animatedGIFWithData:(NSData *)data {
    ...
    if (count <= 1) {
        ...
        NSInteger maxCount = [PLVImagePickerConfig sharedInstance].gifPreviewMaxImagesCount ?: 50;
