...
typedef enum : NSUInteger {
    PLVAssetModelMediaTypePhoto = 0,
    PLVAssetModelMediaTypeLivePhoto,
    PLVAssetModelMediaTypePhotoGif,
    PLVAssetModelMediaTypeVideo,
    PLVAssetModelMediaTypeAudio
} PLVAssetModelMediaType;

@class PHAsset;
@interface PLVAssetModel : NSObject

@property (nonatomic, strong) PHAsset *asset;
@property (nonatomic, assign) BOOL isSelected;      ///< The select status of a photo, default is No
@property (nonatomic, assign) PLVAssetModelMediaType type;
...
@class PHFetchResult;
@interface PLVAlbumModel : NSObject
