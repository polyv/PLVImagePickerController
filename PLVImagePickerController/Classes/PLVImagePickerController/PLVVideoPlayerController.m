...
@interface PLVVideoPlayerController () {
    AVPlayer *_player;
...
@implementation PLVVideoPlayerController
...
- (void)editButtonClick {
    ...
    PLVVideoCropController *videoCropVc = [[PLVVideoCropController alloc] init];
...
- (void)doneButtonClick {
    ...
    if (imagePickerVc.allowEditVideo) {
        ...
        [[PLVImageManager manager] getVideoOutputPathWithAsset:_model.asset presetName:imagePickerVc.presetName success:^(NSString *outputPath) {
